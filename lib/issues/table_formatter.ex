defmodule Issues.TableFormatter do
  ...
  each column. The `headers` parameters contains the
  ...
  @doc """
  Return a format string tahta hard codes the widths of a set of columns.
  ...
  minuses, with + signs where the vertical bar between the columns goes.
